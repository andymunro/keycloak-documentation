...
The initial config file can be obtained from the Admin Console.

. Log in to the Admin Console.
. Click *Clients* in the menu
. Click the corresponding client.
. Click the *Installation* tab and select *Keycloak OIDC JSON*.

==== Configuration options for a Java adapter

...
WARNING: Starting with Chrome version 80 (released on February 2020), silent `check-sso` functionality will work only -when the SSL / TLS connection is configured on the {project_name} side.

...
. Set the `auth-method` to `KEYCLOAK-SAML` in `web.xml`.

. Use standard servlet security to specify role-base constraints on your URLs. Here is an example _web.xml_ file:

...
You cannot configure users with the Client Registration CLI. Use the Admin Console  or the Admin Client CLI to configure users. See link:{adminguide_link}[{adminguide_name}] for more details.

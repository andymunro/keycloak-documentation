...
After the installation, you must configure a federated SSSD store.

.Procedure
. From the left menu, click *User Federation*.
. Click the *Add Provider* drop-down list.
. Click _sssd_, and {project_name} brings you to the sssd configuration page.
. Click *Save*.
